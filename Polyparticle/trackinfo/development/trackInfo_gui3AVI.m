function varargout = trackInfo_gui3AVI(varargin)
...
% Last Modified by GUIDE v2.5 13-Jun-2011 16:28:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @trackInfo_gui3AVI_OpeningFcn, ...
    'gui_OutputFcn',  @trackInfo_gui3AVI_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function trackInfo_gui3AVI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = trackInfo_gui3AVI_OutputFcn(hObject, eventdata, handles)
...
handles.stitchOpt.perform = 1;
handles.stitchOpt.tThresh = 0.5; %Set at half a second
handles.stitchOpt.pixThresh = 0.5; %Set at half a micron
handles.track_analysisOpt.displacementThresh = 1;
handles.runhaltOpt.Lpix = 1;
...
dcm_obj = datacursormode(trackInfo_gui3AVI);
...
Lpix = handles.runhaltOpt.Lpix*str2double(get(handles.pixelsizeedit,'String'));
haltTscale = handles.runhaltOpt.haltTscale*str2double(get(handles.framerateedit,'String'));
[nRuns,runToggle,nHalts,haltToggle]=runhalt2(handles.position{str2double(nam(10:end))},Lpix,haltTscale);
